...
type ProviderSource struct {
	...
	Provider        string               `json:"provider,omitempty" yaml:"provider,omitempty" doc:"Provider name or reference (mutually exclusive with call)" example:"parameter" maxLength:"100" pattern:"^[a-zA-Z0-9][a-zA-Z0-9._:/@^~><=+*-]*$" patternDescription:"A provider name or reference: bare name, name@version, or registry/name@version"`
...
type ProviderTransform struct {
	spec.CallRef    `yaml:",inline"`
	Provider        string               `json:"provider,omitempty" yaml:"provider,omitempty" doc:"Provider name or reference (mutually exclusive with call)" example:"cel" maxLength:"100" pattern:"^[a-zA-Z0-9][a-zA-Z0-9._:/@^~><=+*-]*$" patternDescription:"A provider name or reference: bare name, name@version, or registry/name@version"`
	Inputs          map[string]*ValueRef `json:"inputs,omitempty" yaml:"inputs,omitempty" doc:"Provider inputs" required:"false"`
...
type ProviderValidation struct {
	spec.CallRef `yaml:",inline"`
	Provider     string               `json:"provider,omitempty" yaml:"provider,omitempty" doc:"Provider name or reference (mutually exclusive with call)" example:"validation" maxLength:"100" pattern:"^[a-zA-Z0-9][a-zA-Z0-9._:/@^~><=+*-]*$" patternDescription:"A provider name or reference: bare name, name@version, or registry/name@version"`
	Inputs       map[string]*ValueRef `json:"inputs,omitempty" yaml:"inputs,omitempty" doc:"Provider inputs" required:"false"`
