...
func (s *Server) registerSolutionTools() {
	...
	renderSolutionTool := mcp.NewTool("render_solution",
		...
		mcp.WithString("graph_type",
			...
			enumOpt("action", "resolver", "action-deps"),
		),
	...
	renderEffectiveSolutionTool := mcp.NewTool("render_effective_solution",
		...
		mcp.WithString("section",
			...
			enumOpt(effective.ValidSections...),
		),
		mcp.WithString("format",
			mcp.Description("Output format: yaml (default) or json"),
			enumOpt(string(effective.FormatYAML), string(effective.FormatJSON)),
		),
		mcp.WithString("cwd",
			mcp.Description(cwdDescDefault),
		),
